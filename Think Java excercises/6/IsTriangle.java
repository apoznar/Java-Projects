...
public class IsTriangle {
    /** 
     * This main method takes three arguments and prints isTriangle output.
     */
    public static void main(String[] args) {
        System.out.println(isTriangle(2, 2, 4));
    }
    /** 
     * Uses if-else loop and changes boolean 
     * value of a variable if certain conditions are met.
     */
