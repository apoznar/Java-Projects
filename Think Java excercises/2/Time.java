...
public class Time {
    /**
     * makes use of set variables by printing number of seconds 
     * since midnight, remaining seconds in a day, fraction of a day
     * spent that has passed and seconds spent on this excersize.
     */
