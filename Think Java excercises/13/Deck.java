...
/**
 * The Deck class implements an application that 
 * sorts and reorders a set of cards.
 * Its code is compilable, but it's for testing purposes only.
 *
 * @author  Adam Poznar
 * @version 1.2
 * @since   2018-09-23
