...
/** 
 * The GuessStarter class implements an application that
...
public class GuessStarter {
    /**
     * Takes input between 1-100, generates random number within this range,
     * computes difference between both of them and prints them altogether.
     */
