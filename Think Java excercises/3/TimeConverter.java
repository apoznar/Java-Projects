...
public class TimeConverter {
 /** 
 * This main method takes user input in seconds,
 * tranform them to hours, minutes and seconds,
 ...
 */
   public static void main(String args[]){
      ...
      * to obtain number of hours, then takes modulus from these seconds as seconds left,
      * and number of minutes is calculated by dividing seconds left by 60 (number of seconds in minute).
      * Then it prints all relevant values and closes input.
      */
